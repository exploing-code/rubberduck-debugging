  ...
  return (
    ...
    >
      ...
      <audio
        id='myAudio'
        ref={songRef}
        src='../sound-effects/Wobbly-duck.mp3'
      ></audio>
      <Visualizer />
      {renderLoadingYES ? (
        <LoadingScreenToSection sectionId='s2' text='Try another duck!' />
      ) : null}
      {renderLoadingNO ? (
        <LoadingScreenToSection sectionId='s1' text="Party's over" />
      ) : null}
    </section>
  );
}
