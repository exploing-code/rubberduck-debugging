...
export default function App() {
  ...
  return (
    <section className=' relative flex items-center justify-center'>
      ...
      <div className=' absolute   *:uppercase *:px-4 *:rounded-[1rem] text-xl *:m-2 *:pt-2 left-0 top-0 z-20 *:border-black *:border-[1px] *:items-center *:justify-center *:gap-4  *:flex'>
        ...
        <div>
          ...
          <input
            type='checkbox'
            id='checkbox'
            onChange={(e) => toggleDuckResponding(e)}
          />
        </div>
      </div>
      ...
      <div
        ref={visualizerRef}
        style={{ backgroundColor: ducks[activeDuck].secondaryClr }}
        className=' absolute bottom-0 w-full transition-all duration-[0.05s]'
      ></div>
      <h1
        ref={titleRef}
        style={{ color: ducks[activeDuck].secondaryClr }}
        className=' opacity-0 text-[30vw] leading-[25vw] z-50 pointer-events-none scale-0'
      >
        QUACK
        <br />
        QUACK
