	...
	return (
		<section className=" w-screen relative flex items-center justify-center z-10">
			<div className="flex gap-6 absolute top-0 ">
				<button className="bg-yellow-400 py-4 px-6 rounded-md transition-all duration-200 hover:scale-110 hover:bg-yellow-200" >NO</button>
				<button className="bg-yellow-400 py-4 px-6 rounded-md transition-all duration-200 hover:scale-110 hover:bg-yellow-200">YES</button>
			</div>
