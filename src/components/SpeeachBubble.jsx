...
export default function SpeechBubble({ direction, textReveal1, textReveal2, sectionRef }) {
	...
	return (
		<div className="relative flex items-center">
			<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="-370 50 2000 1073" fill={fillColor} className={` w-[50em] ${isLeft ? "" : "transform scale-x-[-1]" }`}>
				<path
					className="cls-1"
			...
			<div className="absolute w-[40%] h-[40%]  ml-16 mt-10">
				<P>
