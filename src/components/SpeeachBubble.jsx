	...
	return (
		<div ref={bubbleRef} className="relative flex items-center justify-center">
			<svg
				...
				className={`  w-[17em] sm:w-[27em] ${direction === "left" ? " rotate-12" : "transform scale-x-[-1] -rotate-12"} sm:rotate-0`}>
			...
			<div className={`absolute w-[70%] sm:w-[70%] h-[30%] ${direction === "left" ? "sm:ml-8 mt-3 " : "sm:-mt-4 "} -mt-8 text-center sm:text-left sm:mt-6 `}>
